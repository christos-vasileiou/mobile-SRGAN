...
from ax3dgenperc.train3d import train
from ax3dgenperc.get3data import get3Data
...
def main(argv):
    ...
    for i in range(50):
        ...
        wandb.init(project="tiftrc-3d-GenPerc", name=f'AxTrial-{i}', entity="chrivasileiou", config = hps)
