...
from ax3dwgan.train3d import train
from ax3dwgan.get3data import get3Data
...
def main(argv):
    ...
    for i in range(1):
        ...
        wandb.init(project="tiftrc-3d-WGAN", name=f'AxTrial-{i}', entity="chrivasileiou", config = hps)
