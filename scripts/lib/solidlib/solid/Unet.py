...
flags.DEFINE_integer('nchan', 
                     4, 
                     'set a number of channels. The number of channels are doubled as we go deeper to the Encoder of the Unet. On the other hand the number of channels are halved as we go up to the Decoder of the Unet. The last layer is hardcoded to 1 (same as input - Regression). default: 4') 

flags.DEFINE_integer('depth', 
                     2, 
                     'set a number of the Unet\'s depth. default: 2') 
...
flags.DEFINE_boolean('retain_shape', 
                    False, 
                    'set if the shape of the output resolution of the Unet will be the same as input. default: True')
